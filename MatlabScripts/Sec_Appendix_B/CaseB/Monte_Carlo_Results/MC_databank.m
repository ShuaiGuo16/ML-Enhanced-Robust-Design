...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OBJECTIVE
%   ===> Perform Monte Carlo simulation for Appendix B (case B)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% IMPLEMENTATION
...
Cov_current = [(0.03*flame_ref(1))^2,0,0,0;...
    0,(0.03*flame_ref(2))^2,0,0;...
    0,0,(0.03*flame_ref(3))^2,0;...
    0,0,0,(0.03*flame_ref(4))^2];
sample_num = 20000;
