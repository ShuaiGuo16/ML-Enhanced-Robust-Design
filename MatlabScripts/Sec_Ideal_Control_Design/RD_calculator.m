function [Pf] = RD_calculator(tau,X,GP)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OBJECTIVE
%   ===> Calculate risk factor given tau_c value
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INPUTS
%   ===> tau: scalar, tau_c
...
% 2-Scale tau_c 
tau_c = tau;   scale_tau_c = 1/2.8*(tau_c-2);    % Units: ms

% 3-Expand MC samples
en_X = [X(:,1:2),scale_tau_c*ones(sample_num,1),X(:,3:end)];
