...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OBJECTIVE
%   ===> Estimate optimum tau_c for task 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
options = optimoptions('patternsearch','Display','iter','PlotFcn',@psplotbestf,'MeshTolerance',1e-9);
x0 = 3.7; % Unit: ms
LB = 2;   % Lower bound, Unit: ms
UB = 4.8;  % Upper bound, Unit: ms

[x,fval] = patternsearch(@(tau)Extend_RD_objective(tau,X,GP),x0,[],[],[],[],LB,UB,[],options)